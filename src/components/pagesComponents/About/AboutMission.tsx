import banner from "../../../assets/images/about-company-mission.jpg";
    ...
    <section>
      <div className="flex flex-col md:flex-row lg:items-center">
        <div className="mt-8 px-1 lg:mt-0 md:mr-6 xl:mr-14 mb-8 md:mb-0">
          <h3 className="text-4xl font-bold text-common-600 text-priColor">
            Our Mission
          </h3>
          <p className="mt-4 text-gray-600 tracking-wide leading-7 font-medium">
            At{" "}
            <span className="text-common-600 font-bold text-xl">MBooking</span>,
